...
// Only allow access to the Controller
var Controller = (function() {
  ...
  var C = (function() {
    ...
    this.setSegments = function(segments) {
      M.setSegments(parseInt(segments));
      restart();
    };
...
window.onload = function() {
  ...
  $("#btnStart").on('click', function() {
    (Controller.getState() === Controller.state.RUNNING) ? Controller.stop() : Controller.start();
  });

  $("#inputSegments").change(function() {
    Controller.setSegments($(this).val());
    Controller.restart();
  });
